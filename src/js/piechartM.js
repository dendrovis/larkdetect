...
var Dial = function(containerM) {
    this.containerM = containerM;
    this.size = this.containerM.dataset.size - 200; //control overall size
    this.strokeWidth = this.size / 8;
    this.radius = (this.size / 2) - (this.strokeWidth / 2);
    this.value = this.containerM.dataset.value;
    this.direction = this.containerM.dataset.arrow;
    this.svg;
    this.defs;
    this.slice;
    this.overlay;
...
Dial.prototype.create = function() {
    ...
    this.createText();
    this.createArrow();
    this.containerM.appendChild(this.svg);
};
...
var containersM = document.getElementsByClassName("chartM");
var dial = new Dial(containersM[0]);
dial.animateStart();